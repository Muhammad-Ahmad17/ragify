      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="section-title mb-3">
            Built for your content, not generic AI
          </h2>
          <p className="section-desc max-w-xl mx-auto">
            Index once, answer accurately, embed anywhere — without running your
            own vector stack.
          </p>
        </div>
      </section>
...
function FeatureRow({ feature }: { feature: (typeof FEATURES)[number] }) {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={`feature-row-copy ${feature.reverse ? "lg:[direction:ltr]" : ""}`}
        >
        ...
        <div
          className={`feature-row-visual ${feature.reverse ? "lg:[direction:ltr]" : ""}`}
        >
  ...
  return (
    <VisualFrame label="ragify · indexing">
      <div className="p-5 space-y-4" style={{ background: "var(--demo-bg)" }}>
        ...
        <div>
          <div
            className="flex justify-between text-[10px] mb-1.5 font-mono"
            style={{ color: "var(--demo-muted)" }}
          >
      ...
      <div className="p-5 space-y-3" style={{ background: "var(--demo-bg)" }}>
        ...
        >
          ...
          <code
            ...
            style={{ background: "var(--demo-bg)", color: "var(--demo-code)" }}
          >
            class=&quot;dark&quot;
          </code>{" "}
          to your{" "}
