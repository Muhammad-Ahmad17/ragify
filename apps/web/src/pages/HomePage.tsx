    ...
    <section className="relative pt-36 pb-20 px-5 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <p className="text-base sm:text-lg max-w-2xl mx-auto mb-10 leading-relaxed anim-fade-up delay-1 section-desc">
          Ragify indexes your content — text, URLs, and PDFs — and gives you a
          one-line embed. Visitors get accurate answers from your knowledge, not
          random guesses.
        </p>
    ...
    >
      <div className="max-w-4xl mx-auto text-center mb-14">
        ...
        <p className="section-desc">
          Three steps from zero to a live AI assistant.
        </p>
      </div>
          ...
          return (
            <div key={s.n} className="how-step-card">
              <div className="how-step-card-inner h-full flex flex-col p-6 text-left">
                ...
                <h3
                  className="text-[0.9375rem] font-semibold mb-2 tracking-tight"
                  style={{ color: "var(--fg)" }}
                >
                  {s.title}
                </h3>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {quotes.map((q) => (
            ...
            >
              <p
                className="text-[0.9375rem] leading-relaxed mb-6 flex-1"
                style={{ color: "var(--fg)" }}
              >
                {q.text}
              </p>
              <footer className="flex items-center gap-3">
                ...
                <span className="badge badge-success ml-auto shrink-0">
                  {q.metric}
                </span>
              </footer>
            </blockquote>
      ...
      <div className="max-w-4xl mx-auto grid md:grid-cols-3 gap-4 items-start">
        <PriceCard
          ...
          features={[
            {
              label: "1 chatbot",
              detail: "One AI assistant for a single site or project",
            },
            { label: "100 pages indexed", detail: "Text, URLs, and PDFs" },
            {
              label: "500 messages / month",
              detail: "Enough for testing with real visitors",
            },
            {
              label: "Ragify badge",
              detail: "Small powered-by link on the widget",
            },
          ]}
          cta="Start free"
          href="/login"
        ...
        <PriceCard
          ...
          features={[
            {
              label: "3 chatbots",
              detail: "Run assistants for multiple sites or products",
            },
            {
              label: "1,000 pages indexed",
              detail: "Full docs sites and marketing pages",
            },
            {
              label: "5,000 messages / month",
              detail: "Steady traffic without overages",
            },
            {
              label: "Remove branding",
              detail: "White-label widget — no Ragify badge",
            },
          ]}
          cta="Join waitlist"
        ...
        <PriceCard
          ...
          features={[
            {
              label: "10 chatbots",
              detail: "Separate bots per product, locale, or client",
            },
            {
              label: "10,000 pages indexed",
              detail: "Large docs, blogs, and knowledge bases",
            },
            {
              label: "25,000 messages / month",
              detail: "High-volume support and sales chat",
            },
            {
              label: "Conversation history",
              detail: "Review what visitors asked in the dashboard",
            },
          ]}
          cta="Join waitlist"
          soonNote="Stripe checkout coming soon"
...
function PriceCard({
  ...
  return (
    ...
    >
      ...
      <p className="text-sm font-medium mb-0.5" style={{ color: "var(--fg)" }}>
        {name}
      </p>
      ...
      <p
        className="text-3xl font-medium tracking-tight mb-5"
        style={{ color: "var(--fg)" }}
      >
        {price}
        <span
    ...
    >
      <div className="cta-gradient-border text-center">
        <h2 className="section-title mb-4">
          Your content deserves better answers.
        </h2>
        <p className="section-desc mb-6 max-w-sm mx-auto">
